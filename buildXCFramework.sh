...
makeXCFramework() {
  ...
  -debug-symbols ${IOS_DEVICE_ARCHIVE_PATH}/BCSymbolMaps/${IOS_UUID}.bcsymbolmap \
  ...
  -debug-symbols ${TV_DEVICE_ARCHIVE_PATH}/BCSymbolMaps/${TVOS_UUID}.bcsymbolmap \
  ...
  -debug-symbols ${WATCH_DEVICE_ARCHIVE_PATH}/BCSymbolMaps/${WATCHOS_UUID}.bcsymbolmap \
